...
SELECT COUNT(*) FROM BETANIA.dbo.TMRESULTADOSLABORATORIOD WHERE RL2_COD_TIPO IN ('RL','RL8')
GO
SELECT COUNT(*) FROM Reportes.dbo.ResultadosLaboratorio WHERE TipoCodigo IN ('RL','RL8')